...
|  | Example                                                                                                                                  |
|--| ---------------------------------------------------------------------------------------------------------------------------------------- |
|01| [cli_with_callback](https://github.com/dotflow-io/examples/blob/cli_with_callback.py)                                     |
|02| [cli_with_initial_context](https://github.com/dotflow-io/examples/blob/cli_with_initial_context.py)                       |
|03| [cli_with_mode](https://github.com/dotflow-io/examples/blob/cli_with_mode.py)                                             |
|04| [cli_with_output_context](https://github.com/dotflow-io/examples/blob/cli_with_output_context.py)                         |
|05| [cli_with_path](https://github.com/dotflow-io/examples/blob/cli_with_path.py)                                             |
|06| [simple_cli](https://github.com/dotflow-io/examples/blob/simple_cli.py)                                                                 |
|07| [simple_class_workflow](https://github.com/dotflow-io/examples/blob/simple_class_workflow.py)                             |
|08| [simple_function_workflow_with_error](https://github.com/dotflow-io/examples/blob/simple_function_workflow_with_error.py) |
|09| [simple_function_workflow](https://github.com/dotflow-io/examples/blob/simple_function_workflow.py)                       |
|10| [step_class_result_context](https://github.com/dotflow-io/examples/blob/step_class_result_context.py)                     |
|11| [step_class_result_storage](https://github.com/dotflow-io/examples/blob/step_class_result_storage.py)                     |
|12| [step_class_result_task](https://github.com/dotflow-io/examples/blob/step_class_result_task.py)                           |
|13| [step_function_result_context](https://github.com/dotflow-io/examples/blob/step_function_result_context.py)               |
|14| [step_function_result_storage](https://github.com/dotflow-io/examples/blob/step_function_result_storage.py)               |
|15| [step_function_result_task](https://github.com/dotflow-io/examples/blob/step_function_result_task.py)                     |
|16| [step_with_initial_context](https://github.com/dotflow-io/examples/blob/step_with_initial_context.py)                     |
|17| [step_with_many_contexts](https://github.com/dotflow-io/examples/blob/step_with_many_contexts.py)                         |
|18| [step_with_previous_context](https://github.com/dotflow-io/examples/blob/step_with_previous_context.py)                   |
|19| [workflow_keep_going_true](https://github.com/dotflow-io/examples/blob/workflow_keep_going_true.py)                       |
|20| [workflow_step_callback](https://github.com/dotflow-io/examples/blob/workflow_step_callback.py)                           |
|21| [workflow_with_callback_failure](https://github.com/dotflow-io/examples/blob/workflow_with_callback_failure.py)           |
|22| [workflow_with_callback_success](https://github.com/dotflow-io/examples/blob/workflow_with_callback_success.py)           |
|23| [workflow_with_retry](https://github.com/dotflow-io/examples/blob/workflow_with_retry.py)                                 |
