...
class TestTaskBuild(unittest.TestCase):
    ...
    def test_add_method(self):
        ...
        self.assertIsInstance(task.queue[0].task_id, str)
        self.assertEqual(len(task.queue[0].task_id), 26)
    ...
    def test_task_build_result(self):
        ...
        self.assertIsInstance(task_result["task_id"], str)
        self.assertEqual(len(task_result["task_id"]), 26)
